...
def sms():
    ...
    conn = mysql.connector.connect(user='user', password='user',#j
                              host='127.0.0.1',
                              database='localhost')
    ...
    SaveCount = ("INSERT INTO MainData (Count, Mature, Total) VALUES (count, maturity, total)") #j
